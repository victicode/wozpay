        ...
        <div class="quote-section">
          <div class="row q-px-none">
            <div class="col-12 bg-white q-pa-md  flex items-center justify-between justify-md-start loan_card" style="">
              <div class="w-100 flex items-center justify-between " style=" flex-wrap: nowrap;"
                ...
                <div class="flex items-center w-80bbbb ">
                  ...
                  <div class="" style="width:75%">
                    <div class="text-weight-medium ellipsis text-turnc" style="font-size: 0.89rem; "> Tarjeta de crédito
                      - Débito </div>
                    <div class=" ellipsis">N° ********** {{ linkCard.number.substring(linkCard.number.length - 4) }}
                    </div>
                  </div>
                </div>
                <div class="q-mr-none cursor-pointer flex items-center">
                  <div class="q-mr-none cursor-pointer">
                    <q-chip :color="linkCard.status == 2 ? 'chip' : linkCard.status == 1 ? 'warning' : 'negative'"
                    ...
                    <q-btn round flat class="q-ml-md-md" @click="goTo()" size="sm">
                      <q-icon name="eva-arrow-ios-forward-outline" size="sm" color="black" />
                    </q-btn>
                  </div>
                </div>
              </div>
