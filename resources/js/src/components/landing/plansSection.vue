<template>
  <div class="q-pt-md">
    <div class="titleSection-lading q-pl-lg q-pr-xl">
      Comienza con un <br> plan de vendedor <br>Dropper
    </div>
  ...
  setup() {
    ...
    const plans = [
      ...
      // },
      {
        ...
        color:'#1cc718',
        bottomTitle:'Registrate por Gs. 250.000 anual',
        mostSell: true,
        free: false,
        cost: 250000,
      ...
      },
      {
        ...
        color:'#0753e7',
        bottomTitle:'Registrate por Gs. 350.000 anual',
        mostSell: false,
        free: false,
        cost: 350000,
        sutitleCost: ''
