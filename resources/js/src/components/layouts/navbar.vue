<template>
  <q-tabs no-caps right-icon="-" active-color="terciary" align="justify"
    ...
    <q-route-tab class="q-px-xs-sm q-px-md-lg" exact :to="'/transactions'" style="width: 20%;">
      <div class="flex flex-center column">
        <q-icon :size="'sm'" :name="'eva-flip-2-outline'" />
    ...
    <q-route-tab class="q-px-xs-sm q-px-md-lg" :to="user.viewBank == 1 ? '/bank_info' : '/account_bank'" exact
      style="width: 20%;">
      <div class="flex flex-center column">
        <q-icon :size="'sm'" :name="icons.outlinedAccountBalance" />
