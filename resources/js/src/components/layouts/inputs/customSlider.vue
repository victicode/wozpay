...
.slider-wrapper {
  ...
  */
  max-width: 400px; 
  margin: 0 auto; /* Centrado en el padre */
}
...
.marker-bubble {
  ...
  cursor: pointer; /* Agregué cursor pointer para que se pueda hacer click en la burbuja */
  ...
  &.marker-active {
    ...
    z-index: 10;
    transform: rotate(45deg) scale(1.15); /* Un poco más grande al seleccionarse */
  }
  &.marker-active3 {
    background-color: $active-orange;
    z-index: 10;
