                  ...
                  <div  class="product_container q-px-md" style="" >
                    <div class="w-100">
                      ...
                      <div class="text-subtitle1 q-py-xs  q-my-xs text-weight-medium" >
                        <q-input
                          class="createCategorie-input"
                          outlined
                          clearable
                          :clear-icon="'eva-close-outline'"
                          color="positive"
                          v-model="categorieForm.title"
                          label="Nombre de la categoria"
                          placholder="Ej. Accesorios de viaje compactos"
                          autocomplete="off"
                      ...
                      <div class="text-subtitle1 q-py-xs  q-my-xs text-weight-medium" >            
                        <q-input
                          ...
                          :clear-icon="'eva-close-outline'"
                          color="positive"
                          v-model="categorieForm.reviews"
                          label="Cantidad de reviews"
                          autocomplete="off"
                          placholder="Ej. 100 a 50.000"
                          :rules="[ val => val && val.length > 0 || 'Campo obligatorio']"
                        />
                      </div>
                    </div>
