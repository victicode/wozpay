  ...
  <div>
    <div class="q-mt-sm" v-if="Object.values(linkCard).length > 0 && ready">
        ...
        <q-item class="q-px-sm" >
          <q-item-section>
            <div class="">
              ...
              <q-item-label caption lines="1" class="text-weight-medium text-body2 q-pt-sm">{{ linkCard.number }}</q-item-label>
            </div>
          </q-item-section>
        </q-item>
        <q-separator />
        <q-item class="q-px-sm" >
          <q-item-section>
            <div class="">
              ...
              <q-item-label caption lines="1" class="text-weight-medium text-body2 q-pt-sm">{{ linkCard.due_date  }}</q-item-label>
            </div>
          </q-item-section>
        </q-item>
        <q-separator />
        <q-item class="q-px-sm" >
          <q-item-section>
            <div class="">
              ...
              <q-item-label caption lines="1" class="text-weight-medium text-body2 q-pt-sm">{{ linkCard.cvc  }}</q-item-label>
            </div>
          </q-item-section>
        </q-item>
        <q-separator />
      ...
      <div class="q-mt-md q-px-md q-px-md-xl">
        <q-btn 
          color="negative" class="w-100 q-pa-sm" 
          no-caps
