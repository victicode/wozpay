    ...
    <div>
      <div class=" q-mt-xs">
        <div class="">
          ...
          <div v-for="(item, index) in withdrawal" :key="index" :style="'background:' + item.color"
            class="q-pt-md q-mb-xs card__logo-pay">
            ...
            <div style="font-weight: 500; font-size: 0.95rem; line-height: 1.7;" :style="'color:' + item.sectionColor"
              class="q-mt-xs q-px-md q-py-md">
      ...
      <div class="q-px-md steps">
        <div v-for="(item, index) in initWozLink" :key="index" class="q-mt-md ">
          <div class="steps__title-section q-mb-sm q-mx-sm">
            ...
            <q-linear-progress rounded size="7px" track-color="backLinear" :value="0.55" color="white" reverse
              class=" links-progress" />
          </div>
          <div class="q-px-sm">
            <q-timeline color="linksLanding" class="linksTimeline">
              <q-timeline-entry v-for="(step, key) in item.steps" color="linksLanding" :title="step.title" :key="key"
                :body="step.text" :icon="`${key + 1}`" />
            </q-timeline>
          </div>
